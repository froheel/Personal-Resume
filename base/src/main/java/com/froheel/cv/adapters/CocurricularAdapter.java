package com.froheel.cv.adapters;
...
public class CocurricularAdapter extends RecyclerView.Adapter {
    private List<DemoItem> demoItems;
    private Context        context;

    public CocurricularAdapter(List<DemoItem> demoItems, Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View           row      = inflater.inflate(R.layout.cocurricular, parent, false);
